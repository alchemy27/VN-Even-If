...
init -1 python hide:
    ...
    style.window.background = Frame("#ffffff", 5, 12)

    ## Margin is space surrounding the window, where the background
    ## is not drawn.

    style.window.left_margin = 20
    style.window.right_margin = 550
    style.window.top_margin = -200
    style.window.bottom_margin = 150
...
python early:
    config.save_directory = "evenif-1495007894"
